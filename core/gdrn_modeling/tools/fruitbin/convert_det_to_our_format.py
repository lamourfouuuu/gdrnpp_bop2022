...
path = "/gdrnpp_bop2022/output/yolox/bop_pbr/yolox_x_640_augCozyAAEhsv_ranger_30_epochs_fruitbin_pbr_fruitbin_bop_test/inference/fruitbin_bop_test/coco_instances_results_bop.json"
ds = mmcv.load(path)
